...
$q = "SELECT result_exam_header.* FROM result_exam_header  WHERE result_exam_header.sectionmaster_Id = '$SectionMaster_Id' Order By sequence ";
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-6"><h3 style="font-weight:bold;font-style:italic;" class="font_all"><i class="fa fa-clock-o text-primary" aria-hidden="true"></i> Master</h3>
        </div>   
    </div>
    ...
    <div class="row">
       ...
       <div class="col-md-12"> 
        ...
        <div class="col-md-9" style="overflow-x: scroll; overflow-y: scroll;">
            ...
            <table class="table table-striped" id="InstanceMaster_Table">
                ...
                <tbody>
                    ...
                    $row_instance_fetch = mysqli_num_rows($instance_fetch_q);

                    if($row_instance_fetch > 0){
                    $i = 1; while($r_instance_fetch = mysqli_fetch_array($instance_fetch_q)){  ?>

                        <tr>
                            <td><?php echo $i; ?></td>
                            <td><?php echo $r_instance_fetch['Header_Name']; ?></td>
                            <td><?php echo $r_instance_fetch['abbr']; ?></td>
                            <td><?php echo $r_instance_fetch['Header_Type']; ?></td>
                            <td><?php echo $r_instance_fetch['sequence']; ?></td>
                            <td>
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <input type="hidden" value="<?php echo $r_instance_fetch['abbr']; ?>" class="<?php echo $r_instance_fetch['Id']; ?> all_fields" name="fetch_edit_abbr">
                                <input type="hidden" value="<?php echo $r_instance_fetch['Header_Type']; ?>" class="<?php echo $r_instance_fetch['Id']; ?> all_fields" name="fetch_edit_Header_Type">
                                <input type="hidden" value="<?php echo $r_instance_fetch['sequence']; ?>" class="<?php echo $r_instance_fetch['Id']; ?> all_fields" name="fetch_edit_sequence">
                            </div>
            ...
            <div class="panel panel-default InstanceCreate_Model">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="add_abbr" name="add_abbr" placeholder="Enter Abbr.">
                        <br>
                        <label for="email">Header Type*  </label>
                        <input type="text" class="form-control" id="add_Header_Type" name="add_Header_Type" placeholder="Enter Header Type">
                        <br>
                        <label for="email">Sequence  </label>
                        <input type="text" class="form-control" id="add_sequence" name="add_sequence" placeholder="Enter Sequence">
            ...
            <div class="panel panel-default EventSelect_Model" id="Edit_Scroll">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <br>
                        <label for="email">Abbreviation*  </label>
                        <input type="text" class="form-control" id="edit_abbr" name="edit_abbr" placeholder="Enter Abbr.">
                        <br>
                        <label for="email">Header Type*  </label>
                        <input type="text" class="form-control" id="edit_Header_Type" name="edit_Header_Type" placeholder="Enter Header Type">
                        <br>
                        <label for="email">Sequence  </label>
                        <input type="text" class="form-control" id="edit_sequence" name="edit_sequence" placeholder="Enter Sequence">
...
$('.edit_instance_btn').click(function(event){
    ...
    var fetch_Edited_abbr = createURL.searchParams.get('fetch_edit_abbr');
    var fetch_Edited_Header_Type = createURL.searchParams.get('fetch_edit_Header_Type');
    var fetch_Edited_sequence = createURL.searchParams.get('fetch_edit_sequence');

    //Assign Value To Editable Compoents
    $('#edit_InstanceId').val(fetch_Edited_Id);
    $('#edit_Header_Name').val(fetch_Edited_Header_Name);
    $('#edit_abbr').val(fetch_Edited_abbr);
    $('#edit_Header_Type').val(fetch_Edited_Header_Type);
    $('#edit_sequence').val(fetch_Edited_sequence);
...
$.ajax({
    url:'./setup/setup_api.php?Edit_ExamHeaderInstance='+'u',
    type:'POST',
    data: EditData,
    dataType: "json",
...
$('.delete_instance_btn').click(function(event){
    ...
    if (confirm('Are you sure you want to Delete Existing header?')) {
        $.ajax({
            url:'./setup/setup_api.php?Delete_ExamHeaderInstance='+'u',
            type: 'POST',
...
$('#submit_addinstance').click(function(event){
   ...
   var add_Header_Type = $('#add_Header_Type').val();
   var add_abbr = $('#add_abbr').val();
   var add_sequence = $('#add_sequence').val();

    if(add_Header_Name == '' || add_Header_Type == '' || add_abbr == ''){
        iziToast.warning({
            title: 'Empty Fields',
    ...
    $.ajax({
        url:'./setup/setup_api.php?Add_ExamHeaderInstance='+'u',
        type:'POST',
        data: {add_Header_Name:add_Header_Name, add_Header_Type:add_Header_Type, add_abbr:add_abbr, add_sequence:add_sequence},
        dataType: "json",
            ...
            if(add_instance_res['status'] == 'success'){
                $.ajax({
                    ...
                    success:function(st_logs){
                        ...
                        iziToast.error({
                            title: 'Duplicate',
                            message: 'Exam Header Already Exist',
                        });
            }
...
$('#import_file_submit').on('click', function(event){
    ...
    setTimeout(function(){
        ...
        $("#DisplayDiv").css("display", "none");
        jQuery.ajax({
            url: './setup/setup_api.php?Add_ExamHeaderInstance_InBulk=u',
            type: 'POST',
